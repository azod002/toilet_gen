...
package gradle.kotlin.dsl.plugins._66c610ea1a83e187b85bb484365bcd57
...
/**
 * The `com.android.ecosystem` plugin implemented by [com.android.build.gradle.AndroidEcosystemPlugin].
 */
internal
val `ComAndroidPluginGroup`.`ecosystem`: PluginDependencySpec
    get() = plugins.id("com.android.ecosystem")
...
/**
 * The `com.android.internal.ecosystem` plugin implemented by [com.android.build.gradle.internal.plugins.AndroidEcosystemPlugin].
 */
internal
val `ComAndroidInternalPluginGroup`.`ecosystem`: PluginDependencySpec
    get() = plugins.id("com.android.internal.ecosystem")
...
/**
 * The `kotlinx-serialization` plugin implemented by [org.jetbrains.kotlinx.serialization.gradle.SerializationGradleSubplugin].
 */
internal
val `PluginDependenciesSpec`.`kotlinx-serialization`: PluginDependencySpec
    get() = this.id("kotlinx-serialization")
...
/**
 * The `org.jetbrains.kotlin.plugin.serialization` plugin implemented by [org.jetbrains.kotlinx.serialization.gradle.SerializationGradleSubplugin].
 */
internal
val `OrgJetbrainsKotlinPluginPluginGroup`.`serialization`: PluginDependencySpec
    get() = plugins.id("org.jetbrains.kotlin.plugin.serialization")
